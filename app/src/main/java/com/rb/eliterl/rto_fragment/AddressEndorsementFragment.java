 ...
 */
public class AddressEndorsementFragment  extends BaseFragment implements View.OnClickListener, IResponseSubcriber {
    ...
    private void initialize(View view) {
        ...
        etCorrect = (EditText) view.findViewById(R.id.etCorrect);
